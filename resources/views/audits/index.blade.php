            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex items-center justify-end mt-4">
                        <x-button-link class="mt-4" :href="route('audits.create')">
                            Audits bearbeiten
                        </x-button-link>
                    </div>
                    @if ($audits->count())
                        <h2 class="text-xl font-bold leading-none text-left lg:text-3xl">Übersicht aller Audits</h2>
                    ...
                    @endif
                    @if ($auditors->count())
                        <h2 class="text-xl font-bold leading-none text-left lg:text-3xl mt-6">Übersicht aller Auditoren</h2>
                        <div class="overflow-x-auto mt-3">
